...
//    // 数据库名
//    private static final String DATABASE_NAME = "WJEMS.db";
//
//    // 数据表名，一个数据库中可以有多个表（虽然本例中只建立了一个表）
//    public static final String TABLE_NAME = "Saomiao";
//
...
//        sBuffer.append("[mailno] TEXT,");
//        sBuffer.append("[chepai] TEXT,");
//        sBuffer.append("[pici] TEXT,");
//        sBuffer.append("[saomiaoshijian] INTEGER)");
//        // 执行创建表的SQL语句
